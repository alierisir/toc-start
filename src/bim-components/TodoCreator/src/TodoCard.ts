...
export class TodoCard extends OBC.SimpleUIComponent {
  ...
  constructor(components: OBC.Components) {
    const template = `
    <div class="list-item" style="display:flex;justify-content: flex-start; column-gap:20px;align-items: center;color:var(--primary-color); border:1px solid var(--primary-color); border-radius:10px; padding:10px">
      <p id="materialIcon" todo-list-functions="toggle-active"><span class="material-symbols-outlined">
        handyman
        </span>
      </p>
      <div>
