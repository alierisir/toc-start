...
export class TodoCard extends OBC.SimpleUIComponent {
  ...
  set fragQty(value: number) {
    const fragQtyElement = this.getInnerElement("fragQty") as HTMLParagraphElement;
    fragQtyElement.textContent = value.toString();
  }
...
>
  <div style="display: flex; justify-content: space-between; align-items: center">
    <p id="materialIcon" todo-list-functions="toggle-active" style="padding: 5px 15px 5px 5px">
